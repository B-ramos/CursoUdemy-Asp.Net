        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Professor>()
                .HasData(new List<Professor>(){
                    ...
                    new Professor(4, 4, "Rodrigo", "Sampaio"),
                    new Professor(5, 5, "Alexandre", "Noruega"),
                });
            ...
            builder.Entity<Aluno>()
                .HasData(new List<Aluno>(){
                    new Aluno(1, 1, "Marta", "Kent", "33225555", DateTime.ParseExact("28/05/2005", "dd/MM/yyyy", null)),
                    new Aluno(2, 2, "Paula", "Isabela", "3354288",  DateTime.ParseExact("28/05/2005", "dd/MM/yyyy", null)),
                    new Aluno(3, 3, "Laura", "Antonia", "55668899",  DateTime.ParseExact("28/05/2005", "dd/MM/yyyy", null)),
                    new Aluno(4, 4, "Luiza", "Maria", "6565659",  DateTime.ParseExact("28/05/2005", "dd/MM/yyyy", null)),
                    new Aluno(5, 5, "Lucas", "Machado", "565685415",  DateTime.ParseExact("28/05/2005", "dd/MM/yyyy", null)),
                    new Aluno(6, 6, "Pedro", "Alvares", "456454545",  DateTime.ParseExact("28/05/2005", "dd/MM/yyyy", null)),
                    new Aluno(7, 7, "Paulo", "José", "9874512",  DateTime.ParseExact("28/05/2005", "dd/MM/yyyy", null)),
                });
